...
-------设置界面
	...
	--lcd.drawNumber(10, 40, RED, MIDSIZE+BOLD + RED )	
...
local function refresh(widget, event, touchState)
	...
	if event == nil and w < 400 and h < 300 then 	
		...
		lcd.drawFilledRectangle( 0,0,lx, ly, MAP_BG_COLOR )--画地图背景
		----横向网格
		lcd.drawLine(0,hy,lx,hy,DOTTED,MAP_LINE_COLOR)
		...
		lcd.drawText(4 , ly-16, tostring(lon).. "E", SMLSIZE + FONT_COLOR )--SMLSIZE + FONT_COLOR
		
		lcd.drawText(lx-28, ly-32,"LAT", SMLSIZE + FONT_COLOR )	
		lcd.drawText(lx-65 , ly-16, tostring(lat) .. "N",  SMLSIZE + FONT_COLOR )--SMLSIZE + FONT_COLOR
